...
private:
    ...
    double koeff = 1;               // коэффициент изменения скорости в зависимости от точки удара в ракетку
    ...
    // флаги
    bool pause = false;         // меню паузы
    bool pause_timeout = false;
    bool start_menu = true;     // стартовое меню
    bool gameplay = false;      // игра
